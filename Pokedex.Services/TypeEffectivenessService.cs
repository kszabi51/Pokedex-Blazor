namespace Pokedex.Services
{
    public static class TypeEffectivenessService
    {
        ...
        private static readonly Dictionary<(string, string), double> _chart = new()
        {
            { ("Fire",     "Fire"),     0.5 }, { ("Fire",     "Water"),    0.5 },
            { ("Fire",     "Grass"),    2.0 }, { ("Fire",     "Ice"),      2.0 },
            { ("Fire",     "Bug"),      2.0 }, { ("Fire",     "Rock"),     0.5 },
            { ("Fire",     "Dragon"),   0.5 }, { ("Fire",     "Steel"),    2.0 },
            { ("Water",    "Fire"),     2.0 }, { ("Water",    "Water"),    0.5 },
            { ("Water",    "Grass"),    0.5 }, { ("Water",    "Ground"),   2.0 },
            ...
            { ("Grass",    "Fire"),     0.5 }, { ("Grass",    "Water"),    2.0 },
            { ("Grass",    "Grass"),    0.5 }, { ("Grass",    "Poison"),   0.5 },
            { ("Grass",    "Ground"),   2.0 }, { ("Grass",    "Flying"),   0.5 },
            { ("Grass",    "Bug"),      0.5 }, { ("Grass",    "Rock"),     2.0 },
            { ("Grass",    "Dragon"),   0.5 }, { ("Grass",    "Steel"),    0.5 },
            { ("Ice",      "Water"),    0.5 }, { ("Ice",      "Grass"),    2.0 },
            { ("Ice",      "Ice"),      0.5 }, { ("Ice",      "Ground"),   2.0 },
            { ("Ice",      "Flying"),   2.0 }, { ("Ice",      "Dragon"),   2.0 },
            { ("Ice",      "Steel"),    0.5 }, { ("Ice",      "Fire"),     0.5 },
            ...
            { ("Ground",   "Flying"),   0.0 }, { ("Ground",   "Bug"),      0.5 },
            { ("Ground",   "Rock"),     2.0 }, { ("Ground",   "Steel"),    2.0 },
            { ("Flying",   "Electric"), 0.5 }, { ("Flying",   "Grass"),    2.0 },
            { ("Flying",   "Fighting"), 2.0 }, { ("Flying",   "Bug"),      2.0 },
            { ("Flying",   "Rock"),     0.5 }, { ("Flying",   "Steel"),    0.5 },
            { ("Psychic",  "Fighting"), 2.0 }, { ("Psychic",  "Poison"),   2.0 },
            { ("Psychic",  "Psychic"),  0.5 }, { ("Psychic",  "Dark"),     0.0 },
            { ("Psychic",  "Steel"),    0.5 },
            { ("Bug",      "Fire"),     0.5 }, { ("Bug",      "Grass"),    2.0 },
            { ("Bug",      "Fighting"), 0.5 }, { ("Bug",      "Poison"),   0.5 },
            { ("Bug",      "Flying"),   0.5 }, { ("Bug",      "Psychic"),  2.0 },
            { ("Bug",      "Ghost"),    0.5 }, { ("Bug",      "Dark"),     2.0 },
            { ("Bug",      "Steel"),    0.5 }, { ("Bug",      "Fairy"),    0.5 },
            { ("Rock",     "Fire"),     2.0 }, { ("Rock",     "Ice"),      2.0 },
            { ("Rock",     "Fighting"), 0.5 }, { ("Rock",     "Ground"),   0.5 },
            { ("Rock",     "Flying"),   2.0 }, { ("Rock",     "Bug"),      2.0 },
            { ("Rock",     "Steel"),    0.5 },
            { ("Ghost",    "Normal"),   0.0 }, { ("Ghost",    "Psychic"),  2.0 },
            { ("Ghost",    "Ghost"),    2.0 }, { ("Ghost",    "Dark"),     0.5 },
            { ("Dragon",   "Dragon"),   2.0 }, { ("Dragon",   "Steel"),    0.5 },
            { ("Dragon",   "Fairy"),    0.0 },
            { ("Dark",     "Fighting"), 0.5 }, { ("Dark",     "Psychic"),  2.0 },
            { ("Dark",     "Ghost"),    2.0 }, { ("Dark",     "Dark"),     0.5 },
            { ("Dark",     "Fairy"),    0.5 },
            { ("Steel",    "Fire"),     0.5 }, { ("Steel",    "Water"),    0.5 },
            { ("Steel",    "Electric"), 0.5 }, { ("Steel",    "Ice"),      2.0 },
            { ("Steel",    "Rock"),     2.0 }, { ("Steel",    "Steel"),    0.5 },
            { ("Steel",    "Fairy"),    2.0 },
            { ("Fairy",    "Fire"),     0.5 }, { ("Fairy",    "Fighting"), 2.0 },
            { ("Fairy",    "Poison"),   0.5 }, { ("Fairy",    "Dragon"),   2.0 },
